...
public class AppiumAndroidNativeAppMobileDemo  {
  ...
  @Test
  @MobileTest(appPath = "src/test/resources/apps/selendroid-test-app-0.15.0.apk",device = "android:6.0", 
		  additionalCapabilities = {"platformName :Android","deviceName:Android Emulator","autoAcceptAlerts:true","autoDismissAlerts:true"}, deviceType = "Android Emulator")
